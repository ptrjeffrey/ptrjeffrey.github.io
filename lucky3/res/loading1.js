(function(){
	var createStyle=function(){
		return "" +
			".cocosLoading{"+
				"position:absolute;margin:-30px -60px;"+
				"padding:0;"+
				"top:50%;"+
				"left:50%"+
			"}"+
