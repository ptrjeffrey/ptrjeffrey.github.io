...
var TopRiverCards = function(){
    ...
    this.resForPos = [];
    this.cardUIList = [];
    for(var i = 211; i >= 200; i--){
        this.resForPos.push(i);
    }
    for(var i = 223; i >= 212; i--){
        this.resForPos.push(i);
    }
...
TopRiverCards.prototype.pushMJ = function(byteCard){
...
TopRiverCards.prototype.popMJ = function(){
...
TopRiverCards.prototype.updatePos = function(){
